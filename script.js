...
// Invoking click action on keyboard
...
// creating function to get new word.
...
// calling getNewWord function so that a new word is available for a fresh instance.

let word = getNewWord();

console.log(word)

// Enter key control. Because I'm shitty at doing things module-wise, this is going to be loooooong.

enterKey.addEventListener('click', e => {
    let string = '';
    if (row1[4].textContent == '') return;
    if (row2[4].textContent == '') {
        for (element of row1) {
            string+=element.textContent;
        } 
    } else if (row3[4].textContent == '') {
        for (element of row2) {
            string+=element.textContent;
        }
    } else if (row4[4].textContent == '') {
        for (element of row3) {
            string+=element.textContent;
        }
    } else if (row5[4].textContent == '') {
        for (element of row4) {
            string+=element.textContent;
        }
    } else if (row6[4].textContent == '') {
        for (element of row5) {
            string+=element.textContent;
        }
    } else {
    ...
    // Returning message when the typed word is not in list

    if (wordsList.includes(string)) {
        if (string == word) {
            switch (this.element.getAttribute('class')) {
                case 'square row-1 col-5':
                    row1.forEach(row => {
                        row.style.color = 'green';
                        congrats.style.display = 'block';
                    })
                    break;
                case 'square row-2 col-5':
                    row2.forEach(row => {
                        row.style.color = 'green';
                        congrats.style.display = 'block';
                    })
                    break;
                case 'square row-3 col-5':
                    row3.forEach(row => {
                        row.style.color = 'green';
                        congrats.style.display = 'block';
                    })
                    break;
                case 'square row-4 col-5':
                    row3.forEach(row => {
                        row.style.color = 'green';
                        congrats.style.display = 'block';
                    })
                    break;
                case 'square row-5 col-5':
                    row5.forEach(row => {
                        row.style.color = 'green';
                        congrats.style.display = 'block';
                    })
                    break;
                case 'square row-6 col-5':
                    row6.forEach(row => {
                        row.style.color = 'green';
                        congrats.style.display = 'block';
                    })
...
// function to change color for rows

function changeColor(row) {
    if (row.textContent == word[0] && row.getAttribute('data-num') == 0 || row.textContent == word[1] && row.getAttribute('data-num') == 1 || row.textContent == word[2] && row.getAttribute('data-num') == 2 || row.textContent == word[3] && row.getAttribute('data-num') == 3 || row.textContent == word[4] && row.getAttribute('data-num') == 4) {
        row.style.color = 'green'
        keys.forEach(key => {
            if (row.textContent == key.textContent) {
                key.style.color = 'green'
            }
        })
        
    } else if (word.includes(row.textContent)) {
...
// To make it so that error message disappears on click
 error.addEventListener('click', () => {
    error.style.display = 'none';
})


// to make it so that the congrats message disappears and the page is refreshed
...
backspaceKey.addEventListener('click', e => {
    if (row6[4].textContent != '' && flag2 == true) {
        for (i=4; i>=0; i--) {
            row6[i].textContent = '';
        }
    } else if (row5[4].textContent == '' && flag2 == true) {
        for (i=4; i>=0; i--) {
            row5[i].textContent = '';
        }
    } else if (row4[4].textContent == '' && flag2 == true) {
        for (i=4; i>=0; i--) {
            row4[i].textContent = '';
        }
    } else if (row3[4].textContent == '' && flag2 == true) {
        for (i=4; i>=0; i--) {
            row3[i].textContent = '';
        }
    } else if (row2[4].textContent == '' && flag2 == true) {
        for (i=4; i>=0; i--) {
            row2[i].textContent = '';
        }
    } else if (row1[4].textContent == '' && flag2 == true) {
        for (i=4; i>=0; i--) {
            row1[i].textContent = '';
        }
    }
